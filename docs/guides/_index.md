...
linkTitle: "Guides"
weight: 20
description: "Task-oriented walkthroughs for running and operating go53."
---

# Guides

Task-oriented walkthroughs for running and operating go53 — installation,
...
- **[Administrator Guide](/guides/administrator-guide/)** — the full operational
  ...
  operations.
- **[Backup & Restore](/guides/backup-and-restore/)** — full backups, the binary
  logical WAL, point-in-time restore, retention, and the on-disk format.
