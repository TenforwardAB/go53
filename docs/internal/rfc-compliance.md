...
| Negative answers | RFC 2308 | partial | NXDOMAIN/NODATA include SOA for known zones; DNSSEC denial records are included when DO is set. |
...
| AXFR/IXFR/NOTIFY | RFC 1995, RFC 1996, RFC 5936 | partial | AXFR and IXFR fallback paths exist; journaled IXFR deltas remain out of scope. |
...
| DNSSEC | RFC 4033, RFC 4034, RFC 4035, RFC 5155 | partial | DNSKEY/RRSIG, NSEC/NSEC3, wildcard denial, query-time signing, longest authoritative zone matching, case-insensitive owner lookups, and RFC 4034 wildcard RRSIG label counts exist; interop validation remains required. |
